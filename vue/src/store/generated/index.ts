...
import JchicodeCheckersJchicodeCheckersCheckers from './Jchicode/checkers/jchicode.checkers.checkers'
...
export default { 
  JchicodeCheckersJchicodeCheckersCheckers: load(JchicodeCheckersJchicodeCheckersCheckers, 'jchicode.checkers.checkers'),
